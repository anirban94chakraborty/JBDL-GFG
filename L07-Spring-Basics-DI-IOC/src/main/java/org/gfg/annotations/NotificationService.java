...
// @Scope("prototype") // @Scope annotation is used to define the scope of a bean [Default Scope: singleton]
public class NotificationService {

    // Field-based Dependency Injection [uses Java Reflection internally]
