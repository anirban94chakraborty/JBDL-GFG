...
public class WebController {
    ...
    public ModelAndView getList() {
        ...
        LOGGER.info("Processing dynamic-list API");
    ...
    // Call to this endpoint will result in a 500 error
    // because @Controller treats the return value as a view name
    // and not an HTTP response (serialized to JSON)
    @GetMapping("/products")
